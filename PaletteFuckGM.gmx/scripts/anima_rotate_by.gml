///anima_rotate_by(target object, angle variation, duration in secs, loop, start animation on stop [[, pivot x, pivot y, pivot cords are absolute]|[, pivot object]] [, easing script])
...
anima_slide_to_ret.value_difference[0] = degtorad(final_angle);
anima_slide_to_ret.value_difference[1] = final_angle;
