///anima_scale_by(target object, x scale displacement factor, y scale displacement factor, duration in secs, loop, start animation on stop [, easing script])
...
*                                                       *
*   - x scale displacement factor: The object's x scale *
*       displacement. Ex: 1.2 will increase the         * 
*       object's x scale in 20%.                        *
*                                                       *
*   - y scale displacement factor: The object's y scale *
*       displacement. Ex: 1.2 will increase the         *
*       object's x scale in 20%.                        *
*                                                       *
