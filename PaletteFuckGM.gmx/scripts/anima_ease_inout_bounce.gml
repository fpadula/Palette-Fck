///anima_ease_inout_bounce(time, start, change, duration)
...
{
    return (anima_ease_in_bounce(argument0 * 2, 0, argument2, argument3) * 0.5 + argument1);
}

return (anima_ease_out_bounce(argument0 * 2 - argument3, 0, argument2, argument3) * 0.5 + argument2 * 0.5 + argument1);
